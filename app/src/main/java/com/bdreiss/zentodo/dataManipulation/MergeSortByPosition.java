...
public class MergeSortByPosition {
    private final ArrayList<Entry> inputArray;

    public MergeSortByPosition(ArrayList<Entry> inputArray){
    ...
    public void merger(int startIndex,int midIndex,int endIndex){
        ...
        while(leftIndex<=midIndex && rightIndex<=endIndex){
            if(inputArray.get(leftIndex).getPosition()<=inputArray.get(rightIndex).getPosition()){
