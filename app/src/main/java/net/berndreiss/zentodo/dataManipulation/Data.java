...
import net.berndreiss.zentodo.dataManipulation.mergeSort.MergeSort;
import net.berndreiss.zentodo.dataManipulation.mergeSort.MergeSortByReminderDate;
import net.berndreiss.zentodo.dataManipulation.mergeSort.MergeSortByListPosition;
    ...
    */
        ...
        for (Entry e : entries){
            ...
            if (e.getFocus()){
                ...
                if (e.getReminderDate() == null) {
                    ...
                    //3. check task is due
                    if (!e.getReminderDate().isAfter(date)) {
                        tasksToPick.add(e);
                    }
                }
            }
    ...
    public ArrayList<Entry> getFocus(){
        ...
        for (Entry e : entries){
            ...
            if (( (e.getRecurrence() != null) && (e.getReminderDate() == null || !e.getReminderDate().isAfter(LocalDate.now()))) &&
